...
- Jinx periodically selects one random living opponent and fires ten straight rockets, 0.1 seconds apart. The locked target ID never changes during the volley, but every launch updates its center direction toward that fighter's current position before adding an independent random angle inside a total 30-degree cone; individual rockets may still miss, and a direct contact only nudges the fighter actually struck.
